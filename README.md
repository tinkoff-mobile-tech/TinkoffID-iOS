...
### Получение debug-реализации `ITinkoffID`
Теперь, когда ваше приложение настроено и отладочное приложение установлено, можно собрать реализацию `ITinkoffID` для отладки. Сделать это можно следующим образом:
